...
public class main2 {
	...
	public static void main(String[] args) {
			...
			Book2 b1 =  new RentalBook("el señor de los anillos", 543, 200, "tapa dura",LocalDate.of(2013, 4, 15), false, LocalDate.of(2013, 4, 15), 5);
			Book2 b2 =  new SaleBook("harry potter", 345, 298, "tapa blanda",LocalDate.of(2014, 2, 13), 45.67);
